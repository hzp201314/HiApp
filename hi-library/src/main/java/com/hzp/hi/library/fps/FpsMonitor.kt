package com.hzp.hi.library.fps
...
object FpsMonitor {
    ...
    fun listener(callback: FpsCalback) {
        fpsViewer.addListener(callback)
    }

    interface FpsCalback {
    ...
    private class FpsViewer {
        ...
        init {
            ...
            frameMonitor.addListener(object : FpsCalback {
        ...
        fun addListener(callback: FpsCalback) {
