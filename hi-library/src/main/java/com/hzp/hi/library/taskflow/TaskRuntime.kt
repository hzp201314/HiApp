...
internal object TaskRuntime {
    ...
    private val blockTaskId: MutableList<String> = mutableListOf()
    ...
    private fun hasBlockBehindTask(task: Task): Boolean {
        ...
        for (behindTask in behindTasks) {
            ...
            val behindTaskIno = getTaskRuntimeInfo(behindTask.id)
            return if (behindTaskIno != null && behindTaskIno.isBlockTask) {
                true
            } else {
